        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="../../controllers/controller_add_article.php" method="post">
                    ...
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="sumary_id">MÃ tác giả</span>
                        
                        <input type="text" class="form-control" name="tacgia">
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="sumary_id">Ngày viết</span>
                        
                        <input type="datetime" class="form-control" name="ngay">
                    </div>
